...
public class ScanNode extends PlanNode.Leaf {
  ...
  public String getIndexName(){
		return this.indexscheme.toString();
	  }
  public ExprTree getScanCondition(){
	  return condition;
  }
  public void setScanCondition(ExprTree condition){ this.condition = condition; }
