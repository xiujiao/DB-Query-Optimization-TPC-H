...
public class Q5 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new Q5());
  }
  public void testRA() {
  ...
  public void testSQL() {
	  ...
	  try {
		List<List<Datum[]>> computedResults = Sql.execFile(new File("test/TPCH_Q5.SQL"),null);  //null execquery //-explain (push down, sort merge, index) optimization //-index 
//		int queryID=0;
