...
public class Q1 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new Q1());
  }
  public void testRA() {
  ...
  public void testSQL() {
	  ...
	  try {
		List<List<Datum[]>> computedResults = Sql.execFile(new File("test/TPCH_Q1.SQL"),null);
...
//	                       
//	      }
//		 PlanNode P=Sql.execFile_plannode(new File("test/TPCH_Q1.SQL"),null);
