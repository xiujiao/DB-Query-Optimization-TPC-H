...
public abstract class Datum implements Comparable<Datum> {  
      ...
      switch(getType()){
        ...
        case DATE:
          switch(d.getType()){
            ...
            case INT: 
            case DATE: return toInt() > d.toInt() ? 1 : -1;
          }
      } 
    } catch (CastError e){}
    return 0;
  ...
  public static class Date extends Datum {
    ...
    public Date(int y, int m, int d) { this.y = y; this.m = m; this.d = d; }
    public String toString() { return ""+y+"-"+m+"-"+d; }
    public boolean toBool() throws CastError
         { throw new CastError("Date", "Bool"); }
    public int toInt() throws CastError
         { return y * 1000 + m * 100 + d; }
    public float toFloat() throws CastError
         { throw new CastError("Date", "Float"); }
    public Schema.Type getType() { return Schema.Type.DATE; }
    public boolean equalsImpl(Datum d) throws CastError 
         { return d.toInt() == toInt(); }
